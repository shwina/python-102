...
These are the thing you *need* to know if you are writing software
...
1. How to organize the code for your project,
...
* A laptop with `Anaconda <https://www.anaconda.com/download/>`_ installed on it
* 1 or more friends.
